...
def main() -> None:
    ...
    parser.add_argument(
        "-u", "--url", help="Vera URL, e.g. http://192.168.1.161:3480; Name eg: \"John Doe\", Pin eg: \"12345678\"", required=True
    )
    parser.add_argument(
        "-n", "--name", help="Name eg: \"John Doe\"", required=True
    )
    parser.add_argument(
        "-p", "--pin", help="Pin eg: \"12345678\"", required=True
    )
